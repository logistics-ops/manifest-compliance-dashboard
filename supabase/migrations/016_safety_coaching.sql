...
alter table public.safety_coaching
add constraint safety_coaching_organization_carrier_fkey
...
alter table public.safety_coaching
add constraint safety_coaching_organization_safety_score_fkey
foreign key (organization_id, safety_score_id)
references public.safety_scores(organization_id, id)
on delete set null;
...
alter table public.safety_coaching
add constraint safety_coaching_organization_inspection_fkey
foreign key (organization_id, inspection_report_id)
